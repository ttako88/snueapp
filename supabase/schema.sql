-- ============================================================
-- ⚠️⚠️⚠️ 운영 DB에 절대 다시 실행하지 마세요 ⚠️⚠️⚠️
-- 이 파일은 모든 테이블을 지우고 새로 만드는 "새 프로젝트 초기 설치용"입니다.
-- 실행하면 유저·글·댓글 데이터가 전부 삭제됩니다.
-- 이미 운영 중인 DB의 변경은 supabase/migrations/ 폴더의
-- 번호 붙은 증분 파일로만 하세요 (기존 데이터를 건드리지 않는 방식).
-- ============================================================
