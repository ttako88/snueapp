...
- 원본 SHA-256 `e536894ba8f504fe08f83cb6964b0791e0f8f46426d93944b2dc241e5926c932`, 451줄.
...
- 남은 행동 시나리오(purge reclaim·3/7/30일 stale·201 엔드투엔드)는 timestamp fixture 필요 — 76 mock + dev 검증 + assertion으로 커버, 필요 시 추가.
...
- **▶️ 미완료(사용자 입회/승인)**: 실제 Route↔dev service_role HTTP E2E(안전 dev secret), Vercel Cron 배포, 운영 적용(B-10), OAuth(Gate 4b). 009 후속 동결 SHA는 GPT 완료 판정 후 기록.
